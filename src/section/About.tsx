...
function About() {
    return (
        <section className="w-full">
            <div className="w-full flex items-start gap-30 max-w-7xl mx-auto px-12 max-md:px-8 max-sm:px-4 py-30 max-md:py-20">
                <div className="flex flex-col gap-5 sticky top-30 max-md:top-20">
                    <div className="min-w-75 max-w-100 w-full bg-paper-2 px-6 py-6.5 border-t-4 border-teal shadow-[4px_6px_0_rgba(28,27,25,0.2)] -rotate-2">
                        ...
                        <dl className="flex flex-col gap-2 mt-4">
                            ...
                            <div className="flex items-center justify-between text-sm border-b border-dashed border-line-soft py-1.5">
                                ...
                                <dd className="text-right text-ink-soft">2+ Years</dd>
                            </div>
                        </dl>
                ...
                <div className="h-screen">
                    ...
                    <div className="flex items-start gap-6.5 mt-10">
                    ...
                    <div className="w-full mt-8">
                        <h4 className="font-mono font-normal text-xs tracking-widest text-pencil pb-2 mb-1.5 border-b-2 border-line uppercase">Education <b className="font-bold lowercase text-coral">// Academic Record</b></h4>
